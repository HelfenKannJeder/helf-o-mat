...
public class OrganisationTestDataFactory {
    ...
    private static final Address ORGANISATION_1_ADDRESS = new Address.Builder()
        ...
        .build();
    private static final Group ORGANISATION_1_OV_STAB = new Group.Builder()
        .setName("OV-Stab")
        .setDescription("Der OV-Stab bildet die Verwaltungseinheit eines Ortsverbands ...")
        .build();
    private static final Group ORGANISATION_1_JUGENDGRUPPE = new Group.Builder()
        .setName("Jugendgruppe")
        .setDescription("Die THW-Jugendgruppe vermittelt Heranwachsenden im Alter von zehn bis 17 Jahren ...")
        .build();
    private static final Group ORGANISATION_1_BAMBINIGRUPPE = new Group.Builder()
        ...
        .build();
    private static final Group ORGANISATION_1_ZUGTRUPP = new Group.Builder()
        .setName("Zugtrupp")
        .setDescription("Der Zugtrupp ist für die Koordination von THW-Einsätzen zuständig ...")
        .build();
    private static final Group ORGANISATION_1_BERGRUNG_1 = new Group.Builder()
        .setName("1. Bergungsgruppe")
        .setDescription("Die 1. Bergungsgruppe (1. BGr) ist ...")
        .build();
    private static final Group ORGANISATION_1_R = new Group.Builder()
    ...
    public static final Organisation ORGANISATION_1 = new Organisation.Builder()
        .setId(new OrganisationId("50758f69-093e-49b4-a514-c7acbd898036"))
        ...
        .setDefaultAddress(ORGANISATION_1_ADDRESS)
        .setAddresses(Collections.singletonList(ORGANISATION_1_ADDRESS))
        .setGroups(Arrays.asList(
            ORGANISATION_1_OV_STAB,
            ORGANISATION_1_JUGENDGRUPPE,
            ORGANISATION_1_BAMBINIGRUPPE,
            ORGANISATION_1_ZUGTRUPP,
            ORGANISATION_1_BERGRUNG_1,
            ORGANISATION_1_R,
            ORGANISATION_1_BEL,
            ORGANISATION_1_ABSTUETZEN,
            ORGANISATION_1_FELDKOCHHERD,
            ORGANISATION_1_THV
        ))
        .setAttendanceTimes(Arrays.asList(
            ...
            new AttendanceTime.Builder()
                ...
                .setGroups(Collections.singletonList(ORGANISATION_1_BAMBINIGRUPPE))
                .build(),
            new AttendanceTime.Builder()
