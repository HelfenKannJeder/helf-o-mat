 ...
 */
@Configuration
@EnableJpaRepositories(basePackageClasses = [Event::class], basePackages = ["de.helfenkannjeder.helfomat.core"], entityManagerFactoryRef = "eventEntityManager", transactionManagerRef = "eventTransactionManager")
